...
export interface InitOutput {
  ...
  readonly closure61289_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure62576_externref_shim: (a: number, b: number, c: any, d: any) => void;
  ...
  readonly closure62583_externref_shim: (a: number, b: number, c: any) => void;

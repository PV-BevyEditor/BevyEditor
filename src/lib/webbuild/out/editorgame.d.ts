...
export interface InitOutput {
  ...
  readonly closure61228_externref_shim: (a: number, b: number, c: any) => void;
  readonly closure62515_externref_shim: (a: number, b: number, c: any, d: any) => void;
  ...
  readonly closure62522_externref_shim: (a: number, b: number, c: any) => void;
